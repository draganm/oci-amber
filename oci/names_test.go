...
func TestValidateRepository(t *testing.T) {
	cases := []struct {
		...
		{"triple underscore", "a___b", false},
		{"hyphen then underscore", "a-_b", false},
		{"dot then underscore", "a._b", false},
		{"hyphen run and double underscore combo", "foo--bar/baz__qux", true},
		...
		{"leading hyphen after slash", "foo/-bar", false},
		{"colon", "app:v1", false},
